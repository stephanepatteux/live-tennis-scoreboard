"""The normalised match shape the browser board consumes.

Every source (the Ultra WebSocket, or the demo simulation) produces match dicts
with EXACTLY these keys, so the front-end does not care where a frame came from.
"""
